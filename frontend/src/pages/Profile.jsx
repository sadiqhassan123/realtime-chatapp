        ...
        <div className='w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]'>
            ...
            >
                ...
                <input
                    ...
                    className='w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] rounded-lg shadow-lg'
                ...
                <input
                    type="text"
                    readOnly
                    className='w-[90%] h-[50px] border-2 border-[#20c7ff] px-[20px] rounded-lg text-gray-400'
                ...
                <button
                    className='px-[20px] py-[10px] bg-[#20c7ff] rounded-2xl shadow-lg text-[20px] w-[200px] mt-[20px]'
                    disabled={saving}
                >
